...
def clusterChains(genotype, data_dict, comp_dict, reduced_clust_nums):
...
# @profile
def evalMOCK(genotype, comp_dict, reduced_clust_nums, cnn_array, max_cnn, num_examples, data_dict, cnn_pairs, base_members, base_centres):
    ...
    chains, superclusts = clusterChains(genotype, data_dict, comp_dict, reduced_clust_nums)
